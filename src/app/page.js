...
//         <p className="text-lg text-gray-600">Search for books and find your next read!</p>
//       </div>
...
//             <div className="bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer hover:shadow-xl transition">
