...
//           {volumeInfo.authors && (
//             <p className="text-lg text-gray-600 mt-2">By {volumeInfo.authors.join(", ")}</p>
//           )}
...
//               return (
//                 <div key={recBook.id} className="bg-white rounded-lg shadow p-4">
...
//                     />
//                   )}
//                   <h4 className="text-lg font-semibold">{recInfo.title || "Untitled"}</h4>
//                   {recInfo.authors && (
